...
import { createSingleUserRule, deleteSingleUserRule, getAllUserRules, getAllUsers, getSingleUserById } from '../services/userService';
...
export const postUserRole = async (req: Request, res: Response) => {
    ...
    try {
        const newRule = await createSingleUserRule({ client_id, description, min_threshold, max_threshold, percentage } as userRules);
